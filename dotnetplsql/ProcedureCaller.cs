 ...
 public class ProcedureCaller {
  ...
  class SysRefCursorType : Type {
        ...
        public override void genWriteThing(StringBuilder sb, AtomicInteger counter, String source) {
            ...
            sb.Append("if rec.col_type = dbms_types.TYPECODE_DateTime then\n");
  ...
  class Argument {
    ...
    private static Queue<ArgumentsRow> fetchArgumentsRows(IDataReader rs) {
        ...
        while (rs.Read()) {
            ...
            r.data_type = rs.GetString(rs.GetOrdinal ("DATA_TYPE"));
...
//            OracleParameter pin = cmd.CreateParameter();
//				pin.UdtTypeName = "ROLAND.VARCHAR2_ARRAY";
//				pin.OracleDbType = OracleDbType.Object;
//				pin.Value = new string[]{ null,"A", "X" };
//				pin.Direction = System.Data.ParameterDirection.Input;
//				pin.ParameterName = "VA";
//				pin.OracleDbTypeEx = OracleDbType.Array;
//				cmd.Parameters.Add(pin);
            ...
            System.Diagnostics.Debug.WriteLine(cstm.CommandText);
            cstm.ExecuteNonQuery();
...
//         ARRAY do_;
//         ARRAY ro;
//        using (OracleCallableStatement cstm = (OracleCallableStatement) this.connection.prepareCall(p.plsqlstatement)) {
//            ArgArrays aa = new ArgArrays();
//            {
//                int i = 0;
//                foreach (Argument arg in p.arguments) {
...
//                }
//            }
//            cstm.setArray(1, (oracle.sql.ARRAY) this.connection.createARRAY(this.effectiveNumberTableName, aa.decimall.toArray(new decimal?[0])));
...
//            cstm.setArray(3, (oracle.sql.ARRAY) this.connection.createARRAY(this.effectiveDateTimeTableName, aa.DateTime.toArray(new Timestamp[0])));
...
//            cstm.registerOutParameter(7, OracleTypes.ARRAY, this.effectiveDateTimeTableName);
...
//        ResArrays ra = new ResArrays();
//
//        foreach (Object o in (Object[]) no.getArray()) {
//            ra.decimall.add((decimal?) o);
//        }
//
//        foreach (Object o in (Object[]) vo.getArray()) {
//            ra.varchar2.add((String) o);
//        }
//
//        foreach (Object o in (Object[]) do_.getArray()) {
//            ra.DateTime.add((Timestamp) o);
//        }
//        Object result;
//        if (p.returnType != null) {

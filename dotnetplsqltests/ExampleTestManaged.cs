...
namespace spinat.dotnetplsqltests
{
    ...
    public class ExampleTestManaged
    {

        public ExampleTestManaged(OracleConnection c)
        {
            this.connection = c;
        }
        ...
        public void example1()
        {
            ...
            ProcedureCaller procCaller = new spinat.dotnetplslmanaged.ProcedureCaller(connection);
